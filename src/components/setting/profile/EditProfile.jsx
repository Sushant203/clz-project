...
const EditProfile = () => {
    ...
    const Submit = (e) => {
        ...
        try {
            ...
            axios
                .put(`http://localhost:8000/user/register/${id}`, formData)
                .then((res) => {
                    if (res.status === 200) {
                        ...
                        return (
                            <Form onSubmit={handleSubmit}>
                                <div className="flex  border-b-2 border-primary">
                                    <img
                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSeH9llEv5AAEqHYkOwwIjcJa0VFPVERRUuw&usqp=CAU"
                                        alt="cab"
                                        height={80}
                                        width={100}
                                        className=""
                                        ...
                                        <img
                                            src={
                                                newImg
                                                    ...
                                                    : `http://localhost:8000/${location.state.image}`
                                            }
